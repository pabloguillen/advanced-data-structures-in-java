...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		...
		List<Integer> finalneighbors = new ArrayList<Integer>();
		List<Integer> onehopneighbors = new ArrayList<Integer>(getNeighbors(v));
		for (Integer neighbor : onehopneighbors) {
			for (Integer secondneighbor : getNeighbors(neighbor)) {
				finalneighbors.add(secondneighbor);
			}
		}
